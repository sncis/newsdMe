...
export const dailyArticles = [
	// {id: 10, title:"daily1 article", description: " daily1 some description", url: " daily1 someUrl", urlToImage: "daily1 url to image", source:{name: "daily1 source"}, isBookmarked: false},
	// {id: 20, title:"daily2 some second article", description: "daily2 some second description", url: "daily2 someUrl", urlToImage: "daily2 url second to image", source:{name: "daily2 source"}, isBookmarked: false},
	{id: 30, title:"daily3 some third article", description: "daily3 some third description", url: "daily3 someUrl", urlToImage: "daily3 url third to image", source:{name: "daily3 source"}, isBookmarked: false},
	// {id: 44, title:"daily4 some fourth article", description: "daily4 some fourth description", url: "daily4 someUrl", urlToImage: "daily4 url fourth to image", source:{name: "daily4source"}, isBookmarked: false},
	// {id: 55, title:"daily5 some fifth article", description: "daily5 some fifth description", url: "daily5 someUrl", urlToImage: "daily5 url to fifth image", source:{name: "daily5 source"}, isBookmarked: false},
	...
	// {id: 35, title:"some fifth article", description: "some fifth description", url: "someUrl", urlToImage: "url to fifth image", source:{name: "name fifth to source"}, isBookmarked: false}
